...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web. a javascript library designed for easy ui design for webapps

1. Describe component state. component state is the memory a component has

1. Describe props. prop is state passed down to its children

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props? anything outside of the scope of the main function
